        ...
        "function" != typeof r
          ...
          : ((function y(o) {
              ...
              return ++f > (1e3 * n.timeout) / u
                ? a(t + " timeout")
                : void (1989 === parseInt(i.getStyle(l, "width"))
  ...
  (v.isLeapYear = function (e) {
    ...
    (v.prototype.render = function () {
      ...
      if (
        ...
        lay(y).html(
          (function () {
            ...
            return (
              ...
              e.push(
                '<div class="laydate-footer-btns">' + l.join("") + "</div>"
              ),
              e.join("")
            );
          })()
        ...
        "styleSheet" in m
          ? (m.setAttribute("type", "text/css"), (m.styleSheet.cssText = c))
          : (m.innerHTML = c),
    ...
    (v.prototype.checkDate = function (e) {
      var t,
        ...
        d =
          ...
          l.isInput(s) ? s.value : "static" === i.position ? "" : s.innerHTML),
        m = function (e) {
      ...
      return "limit" === e
        ...
        : ((d = d || i.value),
          ...
          a &&
            d &&
            l.setValue(i.range ? (l.endDate ? l.parse() : "") : l.parse()),
          e && e(),
          l);
    }),
          ...
          (d.range
            ? e &&
              ...
              "time" === d.type
                ? s.setBtnStatus(
                    "时间",
                    lay.extend({}, s.systemDate(), s.startTime),
                    lay.extend({}, s.systemDate(), s.endTime)
                  )
                : s.setBtnStatus(!0))
    ...
    (v.prototype.list = function (e, t) {
          ...
          lay.each(new Array(15), function (e) {
            ...
            C == D[0] && lay(l).addClass(o),
              ...
              C < a.firstDate.year
                ...
                : C >= a.firstDate.year &&
                  ((i.month = n.max.month), (i.date = n.max.date)),
              a.limit(lay(l), i, t),
              C++;
          }),
          lay(c[v ? 0 : 1])
      ...
      if (
        (h && u.removeChild(h), u.appendChild(y), "year" === e || "month" === e)
      )
          ...
          lay(y)
            ...
            .on("click", function () {
              ...
              if (!lay(this).hasClass(s)) {
                0 === t
                  ? ((l[e] = i), a.limit(lay(a.footer).find(f), null, 0))
                  : (a.endDate[e] = i);
        ...
        o = {
          ...
          clear: function () {
            a.setValue("").remove(),
              ...
              n.range &&
                (delete a.endDate, delete a.startTime, delete a.endTime),
              a.done(["", {}, {}]);
          },
          now: function () {
            var e = new Date();
